...
public class IMGView extends FrameLayout implements Runnable, ScaleGestureDetector.OnScaleGestureListener,
    ...
    public void addStickerText(IMGStickerTextView textView) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if(contentTapListener!=null){
                    contentTapListener.onContentTap();
                }
                break;
            case MotionEvent.ACTION_UP:
            case MotionEvent.ACTION_CANCEL:
    ...
    public void setContentTapListener(OnContentTapListener listener){
        contentTapListener = listener;
    }
}
